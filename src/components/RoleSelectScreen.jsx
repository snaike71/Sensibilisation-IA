...
import { C, MONO, SANS, Logo, Icon, Btn, WaveBg } from './lhctrl-kit.jsx'
...
export default function RoleSelectScreen({ onAdmin, onApprenant, onLogout }) {
    ...
    return (
        <div style={{
            ...
            {user && (
                <div style={{ position: "absolute", top: 24, right: 32, display: "flex", alignItems: "center", gap: 12, zIndex: 1 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", width: "100%", maxWidth: 880, position: "relative", zIndex: 1 }}>
                <Logo size={44} />
