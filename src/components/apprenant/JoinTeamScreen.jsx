...
import { C, MONO, SANS, Logo, Icon, Btn, Kicker, H } from '../lhctrl-kit.jsx'
      ...
      <div style={{ width: "100%", maxWidth: 420, display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        {step === 'code' && (
          <>
            ...
            <form onSubmit={handleCodeSubmit} style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center", marginTop: 24 }}>
              <div style={{ display: "flex", justifyContent: "center", gap: 10, position: "relative", cursor: "pointer", padding: "10px 0" }}>
                ...
                {Array.from({ length: 8 }).map((_, i) => {
                  ...
                  const isFilled = char !== ''
                  return (
                    <div key={i} style={{ width: 54, height: 64, borderRadius: 11, border: `1.5px solid ${isActive ? C.signal : isFilled ? C.signal : C.border}`, background: C.white, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: MONO, fontWeight: 700, fontSize: 28, color: C.ink, boxShadow: isActive ? `0 0 0 3px ${C.signalSoft}` : "none", transform: isActive ? "scale(1.05)" : "none", transition: "all 0.2s" }}>
                      {char}
                    </div>
                  )
                })}
